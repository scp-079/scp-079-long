...
def share_data(client: Bot, receivers: List[str], action: str, action_type: str, data: Union[bool, dict, int, str],
...
def share_regex_count(client: Bot, word_tye: str) -> bool:
